...
if(('webkitSpeechRecognition' in window)){
  ...
  App.speechCommand('go to',{
    ...
    listen: function(datos){
      switch(datos){
        case "home": location.href = "/?listen=on"; break;
        case "dashboard": location.href = "/dashboard?listen=on"; break;
        ...
        case "500 page": location.href = "pages-500.html?listen=on"; break;
        default:
          $.gritter.add({title: "Error",text: "Could not find: <strong>" + datos + "</strong> page, Please try again.",image: 'cz/images/mic-icon.png',class_name: 'clean',time: ''});  
        break;
      }
    }
  });
